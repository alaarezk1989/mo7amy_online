...
return array (
  ...
  'Ascending'=>'تصاعديا',
  'Descending'=>'تنازليا',
  'Information_about_lawyer'=>'معلومات عن المحامى',
  'Cases_That_Participate'=>'عدد القضايا المشترك بها',
  'about_lawyer'=>'عن المحامى',
  'Add_Case'=>'اضف قضية',
   'Edit_Case'=>'تعديل قضيتك',
  'My_Profile'=>'حسابى',
  'Website'=>'الموقع',
   'Our_Goal'=>'هدفنا',
   'Our_Vision'=>'رؤيتنا',
   'Brief'=>'نبذة',
   'footer_brief'=>'  محامى أونلاين أول بوابة إلكترونية تتيح للعملاء عرض القضايا الخاصة بهم والبحث عن المستشار أو المحامى المناسب للدفاع عنهم فى هذه القضايا . 
